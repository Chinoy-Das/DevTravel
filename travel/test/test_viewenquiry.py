...
class TestViewenquiry():
  ...
  def test_viewenquiry(self):
    ...
    self.driver.find_element(By.NAME, "t2").send_keys(Keys.ENTER)
    self.driver.find_element(By.LINK_TEXT, "View Enquiry").click()
